...
describe("SushiGirls interact with MasterChef", function () {
    ...
    it("overall test2", async function () {
        ...
        await network.provider.send("evm_setAutomine", [false]);
        // console.log((await sgirl.sushiGirls(0)).supportedLPTokenAmount.toString());
        // console.log((await sgirl.sushiGirls(1)).supportedLPTokenAmount.toString());
        // console.log((await sgirl.sushiGirls(2)).supportedLPTokenAmount.toString());
        ...
        await network.provider.send("evm_setAutomine", [false]);
        expect((await sgirl.sushiGirls(0)).supportedLPTokenAmount).to.be.equal(200);
        expect((await sgirl.sushiGirls(1)).supportedLPTokenAmount).to.be.equal(300);
        expect((await sgirl.sushiGirls(2)).supportedLPTokenAmount).to.be.equal(500);
